...
export async function register(
  ...
  // Ensure profile exists (trigger usually handles this; fallback if session is active)
  if (data.session) {
  ...
  return {
    success:
      "Account created. Check your email to confirm, then sign in with your new account.",
  };
}
